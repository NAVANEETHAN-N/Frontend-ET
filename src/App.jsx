import Expenseitem from "./component/ExpenseItem.jsx";
...
const App = () => {
  ...
  useEffect(() => {
    axios
      .get("https://expense-tracker-backend-2jt7.onrender.com/get-entries")
      // axios.push('https://expense-tracker-backend-2jt7.onrender.com/add-entry')
      .then((res) => {
  ...
  //         "https://expense-tracker-backend-2jt7.onrender.com/add-entry",
  //         expenseData
  //       );
  ...
  return (
    <>
      ...
      <div className="center">
        <div className="Balance">total: {income + expense}</div>
      </div>
